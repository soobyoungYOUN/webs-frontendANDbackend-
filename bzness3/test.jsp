	...
	<body>
		...
		<%
			...
			if(inpagemove>=((total/100)*10 + 1)){
				...
				out.print("<tr><td width = 1010 align = center><b><a href = 'test.jsp?from="+inpagemove+"&cnt=10&pagemove="+(inpagemove-10)+"'> &lt&lt  </a></b>");		
				for (int i = inpagemove; i < inpagemove + pageprintnum; i++) {
					out.print("<b><a href = 'test.jsp?from="+i+"&cnt=10&pagemove="+(inpagemove)+"'> "+i+" </a></b>");			
				}
				out.print("<b><a href = 'test.jsp?from="+(inpagemove+lastpage)+"&cnt=10&pagemove="+(inpagemove+lastpage)+"'> &gt&gt </a></b>");
