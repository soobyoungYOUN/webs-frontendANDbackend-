...
<form method='post' action='showREC.jsp'> 
   <table cellspacing=1 width=400 border=1> <!-- 테이블 생성 -->
      <tr>
         ...
         <td width=100><p align=center><input type='number' name='searchid' value=''></p></td>
...
<form method='post' name='myform'>
	<table cellspacing=1 width=400 border=1> <!-- 테이블 생성 -->
		...
		<tr>
			...
			<td width=300><p align=center><input type='number' name='korean' value='<%=kor%>'></p></td>
		</tr>
		<tr>
			<td width=100><p align=center>영어</p></td>
			<td width=300><p align=center><input type='number' name='english' value='<%=eng%>'></p></td>
		</tr>
		<tr>
			<td width=100><p align=center>수학</p></td>
			<td width=300><p align=center><input type='number' name='mathmatic' value='<%=mat%>'></p></td>
		</tr>
		<tr>
			<td width=100><p align=center>합계</p></td>
			<td width=300><p align=center><input type='number' name='sum' value='<%=sum%>' readonly ></p></td>
		</tr>
		<tr>
			<td width=100><p align=center>평균</p></td>
			<td width=300><p align=center><input type='number' name='avg' value='<%=avg%>' readonly ></p></td>
		</tr>   
	</table>
<%
