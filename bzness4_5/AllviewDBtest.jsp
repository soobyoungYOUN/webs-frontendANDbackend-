...
<%	//하단의 페이지 목록을 출력
	out.println("<tr><td width=50 align=center><b><a href='AllviewDBtest.jsp?from=" + (int)(Math.floor(startPage/10)*10 -1) + "'>&lt&lt</a></b></td>");
	String sqlPage = "";
	for (int i = startPage; i <= finalPage; i++){
		sqlPage = "<td width=50 align=center><b><a href='AllviewDBtest.jsp?from=" + i + "'>"+ i +"</a></b></td>";
		out.println(sqlPage);
	}
	out.println("<td width=50 align=center><b><a href='AllviewDBtest.jsp?from=" + (int)((Math.ceil(startPage/10) +1)*10) + "'>&gt&gt</a></b></td>");
%>
</table>
</body>
</html>